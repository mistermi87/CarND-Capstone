...
- main_folder
    ...
    - annotions
        ...
        - ....xml
        - ...
- filename_[...].txt (where [...] is one of elements in SET below)
...
# if data is for training, validation etc.
...
# the data is for training, validation or ...
...
def main(_):
    ...
    # check `set` is chosen appropriately
    ...
    examples_path = os.path.join(data_dir, 'filename_' + FLAGS.set + '.txt')
